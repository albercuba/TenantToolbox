...
- [x] Management → Users view for cross-tenant Microsoft 365 user search, multi-select tenant/status/license/department/group/MFA filters, and kebab action menu for lifecycle operations
