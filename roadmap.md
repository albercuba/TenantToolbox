...
6. [x] "Connect a tenant" flow: working frontend action starts admin-consent URL generation → callback → store refresh token, with safe Microsoft token-exchange diagnostics
