...
3. [x] MSP staff auth: first-time setup wizard creates the initial owner, with an explicit login-page setup fallback; local email/password + session/JWT; basic RBAC (owner/tech roles)
